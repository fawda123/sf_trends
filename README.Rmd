...
```{r fig.height = 7, fig.width = 11, echo = F, cache = TRUE}
data(flocor)
...
```{r, fig.height = 7, fig.width = 12, echo = F, message = F, warning = F, cache = TRUE}
...
```{r, fig.height = 10, fig.width = 12, echo = F, message = F, warning = F, eval = T, cache = TRUE}
...
```{r, fig.height = 6.5, fig.width = 10, echo = F, message = F, warning = F, eval = T, cache = TRUE}
...
# the plot
ggplot(perfs, aes(x = stat, y = rmse)) +
